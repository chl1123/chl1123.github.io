...
class Message_2D_CamInfo(_message.Message):
    __slots__ = ["camera_name", "distortion_modle", "header", "is_extrinsics_caib", "is_intrinsics_caib", "m_cx_", "m_cy_", "m_fx_", "m_fy_", "m_infrared", "m_k1_", "m_k2_", "m_k3_", "m_k4_", "m_k5_", "m_k6_", "m_p1_", "m_p2_", "m_seertag_family_id", "m_seertag_size", "model_type", "pitch", "roll", "x", "y", "yaw", "z"]
    ...
    yaw: float
    z: float
    def __init__(self, header: Optional[Union[_message_header_pb2.Message_Header, Mapping]] = ..., camera_name: Optional[str] = ..., m_infrared: Optional[float] = ..., m_seertag_size: Optional[float] = ..., m_seertag_family_id: Optional[float] = ..., model_type: Optional[str] = ..., distortion_modle: Optional[str] = ..., is_intrinsics_caib: bool = ..., is_extrinsics_caib: bool = ..., x: Optional[float] = ..., y: Optional[float] = ..., z: Optional[float] = ..., roll: Optional[float] = ..., pitch: Optional[float] = ..., yaw: Optional[float] = ..., m_fx_: Optional[float] = ..., m_fy_: Optional[float] = ..., m_cx_: Optional[float] = ..., m_cy_: Optional[float] = ..., m_k1_: Optional[float] = ..., m_k2_: Optional[float] = ..., m_k3_: Optional[float] = ..., m_k4_: Optional[float] = ..., m_k5_: Optional[float] = ..., m_k6_: Optional[float] = ..., m_p1_: Optional[float] = ..., m_p2_: Optional[float] = ...) -> None: ...
...
class Message_3DPose(_message.Message):
    ...
    y: float
    z: float
    def __init__(self, header: Optional[Union[_message_header_pb2.Message_Header, Mapping]] = ..., x: Optional[float] = ..., y: Optional[float] = ..., z: Optional[float] = ..., q_w: Optional[float] = ..., q_x: Optional[float] = ..., q_y: Optional[float] = ..., q_z: Optional[float] = ..., extra_data: Optional[str] = ...) -> None: ...
...
class Message_Localization(_message.Message):
    ...
    y: float
    z: float
    def __init__(self, header: Optional[Union[_message_header_pb2.Message_Header, Mapping]] = ..., x: Optional[float] = ..., y: Optional[float] = ..., z: Optional[float] = ..., angle: Optional[float] = ..., roll: Optional[float] = ..., pitch: Optional[float] = ..., confidence: Optional[float] = ..., loc_state: Optional[int] = ..., loc_method: Optional[int] = ...) -> None: ...
