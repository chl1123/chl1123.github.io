...
class Message_2DImage(_message.Message):
    ...
    height: int
    width: int
    def __init__(self, width: Optional[int] = ..., height: Optional[int] = ..., data: Optional[bytes] = ..., encoding: Optional[str] = ..., base64Data: Optional[str] = ..., fx: Optional[float] = ..., fy: Optional[float] = ..., cx: Optional[float] = ..., cy: Optional[float] = ...) -> None: ...
...
class Message_DepthCameraCloud(_message.Message):
    ...
    def __init__(self, header: Optional[Union[_message_header_pb2.Message_Header, Mapping]] = ..., device_name: Optional[str] = ..., cloud: Optional[Iterable[Union[Message_DepthCameraPoint, Mapping]]] = ..., install: Optional[Union[Message_DepthCameraInstallInfo, Mapping]] = ..., device: Optional[Union[Message_DepthCameraDeviceInfo, Mapping]] = ..., image: Optional[Union[Message_2DImage, Mapping]] = ..., cloud_voxel: Optional[float] = ...) -> None: ...
...
class Message_DepthCameraDeviceInfo(_message.Message):
    ...
    def __init__(self, device_name: Optional[str] = ..., point: Optional[Iterable[Union[Message_ScanRangePoint, Mapping]]] = ...) -> None: ...
...
class Message_DepthCameraPoint(_message.Message):
    ...
    y: float
    z: float
    def __init__(self, x: Optional[float] = ..., y: Optional[float] = ..., z: Optional[float] = ..., label: Optional[int] = ...) -> None: ...
