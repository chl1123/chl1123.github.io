...
class Message_Battery(_message.Message):
    __slots__ = ["charge_current", "charge_voltage", "cycle", "extra", "is_charging", "is_manually_connected", "max_charge_current", "max_charge_voltage", "percetage", "temperature", "user_data"]
