...
class msgMotorCmd(_message.Message):
    __slots__ = ["canId", "canRouter", "ioCmd", "key", "moveType", "type", "value"]
    ...
    def __init__(self, key: Optional[str] = ..., canRouter: Optional[int] = ..., canId: Optional[int] = ..., value: Optional[float] = ..., ioCmd: Optional[Union[msgMotorCmd.cmd, str]] = ..., type: Optional[Union[msgMotorCmd.motorType, str]] = ..., moveType: Optional[Union[msgMotorCmd.mType, str]] = ...) -> None: ...
