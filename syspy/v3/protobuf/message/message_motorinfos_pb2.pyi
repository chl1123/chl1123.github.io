...
class msgMotorInfo(_message.Message):
    __slots__ = ["calib", "canId", "canRouter", "current", "emc", "encoder", "err", "errorCode", "followErr", "header", "name", "passive", "position", "rawPosition", "speed", "stop", "temperature", "type", "voltage"]
