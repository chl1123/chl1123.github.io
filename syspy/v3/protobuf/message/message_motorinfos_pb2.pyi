...
class msgMotorInfo(_message.Message):
    __slots__ = ["calib", "canID", "canRouter", "current", "emc", "encoder", "err", "errorCode", "followErr", "header", "motorName", "passive", "position", "rawPosition", "speed", "stop", "temperature", "type", "voltage"]
