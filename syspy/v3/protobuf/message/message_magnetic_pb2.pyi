...
class msgMagneticNode(_message.Message):
    __slots__ = ["header", "id", "key", "resolution", "step", "value", "x", "y", "yaw"]
    ...
    y: float
    yaw: float
    def __init__(self, id: Optional[int] = ..., value: Optional[Iterable[bool]] = ..., x: Optional[float] = ..., y: Optional[float] = ..., yaw: Optional[float] = ..., step: Optional[float] = ..., resolution: Optional[int] = ..., header: Optional[Union[_message_header_pb2.msgHeader, Mapping]] = ..., key: Optional[str] = ...) -> None: ...
