...
from syspy.v4.include.protocol import messageV4_movetask_pb2
...
def main():
    ...
    datapool.publish("battery1", message_battery.MessageV4_Battery)
    ...
    while True:
        ...
        datapool.put("battery1", battery)
        battery.temperature = -temperature
        datapool.put("battery2", battery)
